#line 1 "c:\\edk2\\MdePkg\\Library\\BaseLib\\Ia32\\RdRand.nasm"
...
;------------------------------------------------------------------------------
global _InternalX86RdRand16
_InternalX86RdRand16:
...
;------------------------------------------------------------------------------
global _InternalX86RdRand32
_InternalX86RdRand32:
...
;  Return ((BOOLEAN)(1==1)) if Rand generated successfully, or ((BOOLEAN)(0==1)) if not.
;
;  BOOLEAN __cdecl InternalX86RdRand64 (UINT64 *Rand);
;------------------------------------------------------------------------------
global _InternalX86RdRand64
_InternalX86RdRand64:
    ; rdrand   eax                 ; generate a 32 bit RN into eax
                                   ; CF=1 if RN generated ok, otherwise CF=0
    db     0xf, 0xc7, 0xf0         ; rdrand r32: "0f c7 /6  ModRM:r/m(w)"
